...
const testimonials = [
  ["Andrea helped us turn several disconnected accounts into one clear strategy. We now understand what each investment is intended to do and how it supports our family’s plans.", "AM", "A. & K. Mensah", "Business owners"],
    ...
    <main id="top" className="portfolio-page overflow-hidden bg-ink">
      ...
      <section id="top" className="grid min-h-[calc(100vh-78px)] lg:grid-cols-[1.08fr_.92fr]">
        <div className="order-2 flex flex-col justify-center px-6 py-20 sm:px-12 lg:order-1 lg:px-[6vw]">
          ...
          <p className="body-copy mt-7 max-w-2xl text-[17px]">Personalized investment management and financial strategies designed around your goals, risk profile, and future.</p>
          ...
          <div className="mt-16 grid grid-cols-2 gap-y-5 border-t border-gold/20 pt-7 sm:grid-cols-4">
            {credentials.map(([value,label], index) => <div key={label} className={`group flex items-center gap-2.5 px-3 sm:px-4 ${index > 0 ? "sm:border-l sm:border-gold/25" : "sm:pl-0"}`}><strong className="font-display text-3xl font-medium text-gold transition duration-300 group-hover:text-[#e2c65b]">{value}</strong><span className="max-w-[110px] text-[9px] uppercase leading-4 tracking-[.12em] text-mist">{label}</span></div>)}
          </div>
        </div>
      ...
      <section id="about" className="bg-deep px-6 py-24 sm:px-12 lg:py-32">
        <Reveal className="mx-auto max-w-content">
          ...
          <div className="mt-10 grid gap-12 lg:grid-cols-2 lg:gap-24">
            <div><h2 className="display-title">Andrea Marie Shenocca<br/><em>Financial Advisor &amp; Broker</em></h2><p className="mt-7 text-[10px] uppercase tracking-[.18em] text-gold">39 years of financial-market experience</p></div>
            <div className="space-y-5 body-copy">
              <p>For nearly four decades, I have helped individuals, families, and professionals make informed financial decisions and build strategies designed to grow, protect, and preserve their wealth.</p>
