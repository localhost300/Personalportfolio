...
export const metadata: Metadata = {
  ...
  openGraph: { type: "website", locale: "en_US", url: "/", title: "Andrea Marie Shenocca | Financial Advisor & Broker", description: "Personalized investment management and financial strategies built around your goals, risk profile, and future.", siteName: "Andrea Marie Shenocca Wealth Management", images: [{ url: "/opengraph-image", width: 1200, height: 630, alt: "Andrea Marie Shenocca | Financial Advisor & Broker" }] },
